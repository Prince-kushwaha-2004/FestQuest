...
function Cards({ data }) {
    return (
        <div className=" flex  flex-col w-[99%] transition-all relative p-3 rounded-xl">
            ...
            <img src={data.logo} alt="" className="w-22 h-20 border left-10 top-10 absolute rounded-full  " />


            <img src={data.img} alt="" className="h-[27rem] p-2 border-l border-r border-t rounded-t-lg " />
            ...
            <div className="flex  flex-col justify-between bg-white border-r border-l  border-b border-teal-600 p-4 rounded-b-md">
                ...
                <div>
                    <p className="m-4 text-lg ">{data.description}{data.description}</p>
