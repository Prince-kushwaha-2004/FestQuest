    ...
    return (
        ...
        <div className={`flex  px-4 w-170 flex-col border border-gray-300  transition-all   py-4 rounded-xl`}>
            ...
            <div>
                <div className="flex justify-between ">
                    <div className="text-2xl flex items-center gap-4 font-normal">
                        ...
                        <div>
                            <div>    {data.name} </div>
                            <div className="text-sm py-1 font-light text-gray-800">{data.organiser}</div>

                            <div className="flex gap-4 ">

                                <div className="text-sm font-light text-teal-800">{data.eventType}</div>
            ...
            <Link to={`/event/${data.id}`}>
                ...
                <img src={data.img} alt="" className="h-75 w-170 p-2 mt-1 rounded-2xl  " />
            </Link>
