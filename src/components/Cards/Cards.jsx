...
function Cards() {
    return (
        <div className='bg-[#2847270e] shadow border border-slate-300 w-full  p-4 rounded-4xl'>
            ...
            <p className='m-4 '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut illum quaerat saepe quasi distinctio excepturi quia, vitae sapiente minima voluptas minus, sint iste soluta porro, provident optio ratione enim eos?</p>
            <div className='flex flex-col 2xl:flex-row'>
                <img src="https://storage.googleapis.com/lablab-static-eu/images%2Fevents%2Fcljscjt9r0000356om968xnvk%2Fcljscjt9r0000356om968xnvk_9l13odi_imageLink.jpg" alt="" className='rounded-2xl w-full 2xl:w-1/2  2xl:m-4' />
                <div className='w-full 2xl:w-1/2 p-8 flex flex-wrap gap-x-4 gap-y-2'>
                    <div className='flex gap-4'>
                        <IoIosPeople className='text-[2.7rem] p-2 bg-neutral-200 text-slate-700  shadow rounded-xl ' />
                        <div className=''>
                    ...
                    <div className='flex gap-4'>
                        <BsCalendar2Event className='text-[2.7rem] p-2 bg-neutral-200 text-slate-700  shadow rounded-xl ' />
                        <div className=''>
                    ...
                    <div className='flex gap-4'>
                        <IoPeople className='text-[2.7rem] p-2 bg-neutral-200 text-slate-700 shadow rounded-xl ' />
                        <div className=''>
                    ...
                    <div className='flex gap-4'>
                        <IoMdTime className='text-[2.7rem] sm:p-2 bg-neutral-200 text-slate-700  shadow rounded-xl ' />
                        <div className=''>
                    ...
                    <div className='flex items-center sm:px-4 w-full flex-row gap-4 justify-between flex-wrap'>
                        ...
                        <button className="px-16 py-2 bg-[#00637C] text-white text-md rounded-lg hover:bg-[#00637cc0] ">Register</button>
                    </div>
                </div>
            </div>
