                    ...
                    <Link to={`event/${data.id}`} className="flex flex-wrap gap-x-4 gap-y-2">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="">
                                ...
                                <p className="text-slate-700 text-sm">1 - {data.teamSize} Members</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div className="">
                                ...
                                <p className="text-slate-700 text-sm">{data.daysLeft} days left</p>
                            </div>
                        </div>
                    </Link>
                    <div className="flex items-center sm:px-4 w-full flex-row gap-4 justify-between flex-wrap">
                        <p className="text-2xl font-semibold text-black">&#8377;{data.price}</p>
