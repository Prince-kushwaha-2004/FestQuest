...
export const Links = ({ formData, setFormData, current, setCurrent }) => {
    ...
    return (
        <div className="md:mx-20">
            <Form name="form" layout="vertical" onFinish={onFinish} initialValues={formData.links}>
...
export const Dates = ({ formData, setFormData, current, setCurrent }) => {
    ...
    const onFinish = (fieldsValue) => {
        ...
        setFinalData({ ...finalData, "eventDate": formData.eventDate, "registrationDate": formData.registrationDate, description, name, type, ...formData.eventDetails, "links": formData.links, "sponsors": formData.links.sponsors.fileList, "banner": formData.basic.banner.file, "prizes": formData.dateAndPrices.prizes })
    ...
    return (
        <div className="md:mx-20 flex justify-center">
            <Form name="dateAndPrices" layout="vertical" onFinish={onFinish} initialValues={formData.dateAndPrices}>
                <Form.Item
                ...
                >
                    <RangePicker
                        ...
                        onChange={(_, value) => setFormData({ ...formData, "registrationDate": value })}
                    />
                </Form.Item>
                <Form.Item name="eventDate" label="EVENT DATES" {...rangeConfig}>
                    <RangePicker
                        ...
                        showTime
                        format="YYYY-MM-DD HH:mm:ss"
                        onChange={(_, value) => setFormData({ ...formData, "eventDate": value })}
