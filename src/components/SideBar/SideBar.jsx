...
const Option = ({ Icon, title, selected, setSelected, open, notifs }) => {
    return (
        <motion.button
            ...
            className={`relative flex h-10 w-full items-center rounded-2xl transition-colors ${selected === title ? "shadow bg-[#6cd4b527]  border border-slate-300" : "text-slate-700 hover:bg-[#1d2f331e] hover:text-black"}`}
            style={{
