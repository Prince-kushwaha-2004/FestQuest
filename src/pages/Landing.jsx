...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col h-screen overflow-y-scroll  ">
      ...
      <div className="m-4 mt-0 border-2  border-slate-200 flex-1 bg-teal-500 rounded-4xl  flex flex-col items-center justify-center heading-primary relative">
        <img
          src={Brush}
        ...
        <img
          src={Plan}
          className="w-[8rem] absolute top-70 right-40 z-5"
          alt=""
        />
        <img
          src={Money}
          className="w-[8rem] absolute top-70 left-30 z-5"
          alt=""
        />
