    ...
    return (
        <div className="flex w-screen h-screen ps-28 xl:ps-4 bg-blue-50 flex-col">
            ...
            <div className="h-full sm:m-8 flex justify-center">
                <div className="shadow-xl border bg-white border-slate-200 p-4 rounded-2xl sm:w-[85%] lg:w-[65%] xl:w-[55%] w-[95%] h-full overflow-y-scroll">
                    <h1 className="font-bold mt-8 md:mt-4 mb-8 text-center text-5xl ">
